...
public class ConfigManager {
	...
	public void saveConfig(File fichier) {
		...
		config.set("LGRules.ReducedDebug", main.cord);
	...
	public LGChat getChatByName(String name) {
		
		for (LGChat op : LGChat.values()) {
